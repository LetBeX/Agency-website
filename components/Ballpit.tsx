...
class Z extends InstancedMesh {
  ...
  constructor(renderer: any, params: Partial<typeof XConfig> = {}) {
    ...
    if (Array.isArray(colors) && colors.length > 1) {
      const colorUtils = (function (colorsArr: number[]) {
        ...
        return {
          ...
          getColorAt: (ratio: number, out: any = new Color()) => {
...
const Ballpit: React.FC<BallpitProps> = ({ className = '', followCursor = true, paused = false, ...props }) => {
